...
-- ============================================================
-- ROW LEVEL SECURITY
-- MODO ABERTO (temporário): liberado para qualquer um com o link,
-- enquanto o projeto ainda está em construção. A estrutura de login
-- (tabela `perfis`, funções is_admin/is_active_user) continua criada
-- e pronta — quando quiser reativar o login, é só trocar a linha
-- "using (true) with check (true)" abaixo de volta para
